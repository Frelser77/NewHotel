...
namespace NewHotel.Migrations
{
    ...
    [Migration("20240308120131_Serivizi")]
    partial class Serivizi
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NewHotel.Models.PrenotazioneServizio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NewHotel.Models.Servizio", b =>
                {
                    ...
                    b.Property<int?>("PrenotazioneIdPrenotazione")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PrenotazioneIdPrenotazione");
            ...
            modelBuilder.Entity("NewHotel.Models.PrenotazioneServizio", b =>
                {
                    b.HasOne("NewHotel.Models.Prenotazione", "Prenotazione")
                        .WithMany("PrenotazioneServizi")
                        .HasForeignKey("IdPrenotazione")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NewHotel.Models.Servizio", "Servizio")
                        .WithMany("PrenotazioneServizi")
            ...
            modelBuilder.Entity("NewHotel.Models.Servizio", b =>
                {
                    b.HasOne("NewHotel.Models.Prenotazione", null)
                        .WithMany("Servizi")
                        .HasForeignKey("PrenotazioneIdPrenotazione");
                });
            ...
            modelBuilder.Entity("NewHotel.Models.Prenotazione", b =>
                {
                    b.Navigation("PrenotazioneServizi");
